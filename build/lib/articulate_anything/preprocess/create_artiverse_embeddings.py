...
"""
Create CLIP embedding for each part mesh in the Artiverse dataset
...
def embedding_entries_to_csv(embedding_entries, csv_path="artiverse_embeddings.csv"):
    # use pandas
...
if __name__ == '__main__':
    DATASET_DIR = "/cs/3dlg-jupiter-project/artiverse/singapo_data_full_filtered/"
    ...
    obj_ids = ["towel_ring/wss-1f8f11818515ad253321831d2245cf06"]
